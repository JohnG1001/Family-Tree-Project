...
public class FamilyTree 
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		// The substring of line that starts just after colonIndex and goes through the end of the line.
		...
		else
		{
			...
			if(parentNode == null)
			{
				new TreeException("Parent Node Not Found");
			}
		}
		...
		{
			TreeNode currentChild = new TreeNode(child);
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null) //Throw a TreeException with a useful message
		{
			
		}
		// node whose name is name2	
		TreeNode node2 = root.getNodeWithName(name2);		
		if (node2 == null) // Throw TreeException with a useful message
		{
			throw new TreeException("Invalid Name 2" + name2);
		}
